...
function Card({ name, followers, jours, platform, darkMode }) {
  ...
  return (
    <section className={`relative flex flex-col items-center text-center rounded-md px-6 py-7 overflow-hidden transition duration-200 ${darkMode ? "bg-dark-card-bg hover:bg-gray-700" : "bg-light-card-bg hover:bg-gray-200"}`}>
      ...
      <div className="mt-6">
        <h2 className={`counter text-5xl font-bold leading-none ${darkMode ? "text-dark-white-text" : "text-light-very-dark-text"}`} style={{ "--final": followers }}></h2>
